...
impl ::protobuf::Message for VerificationDetails {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.originChain.is_empty() {
            my_size += ::protobuf::rt::string_size(2, &self.originChain);
        }
        if self.issuanceTimestamp != 0 {
        ...
        if !self.schema.is_empty() {
            my_size += ::protobuf::rt::string_size(6, &self.schema);
        }
        if !self.issuerVerificationId.is_empty() {
            my_size += ::protobuf::rt::string_size(7, &self.issuerVerificationId);
        }
        if self.version != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if !self.originChain.is_empty() {
            os.write_string(2, &self.originChain)?;
        }
        if self.issuanceTimestamp != 0 {
        ...
        if !self.schema.is_empty() {
            os.write_string(6, &self.schema)?;
        }
        if !self.issuerVerificationId.is_empty() {
            os.write_string(7, &self.issuerVerificationId)?;
        }
        if self.version != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \tR\x0boriginChain\x12,\n\x11issuanceTimestamp\x18\x03\x20\x01(\rR\x11is\
    suanceTimestamp\x120\n\x13expirationTimestamp\x18\x04\x20\x01(\rR\x13exp\
    irationTimestamp\x12\"\n\x0coriginalData\x18\x05\x20\x01(\x0cR\x0corigin\
    alData\x12\x16\n\x06schema\x18\x06\x20\x01(\tR\x06schema\x122\n\x14issue\
    rVerificationId\x18\x07\x20\x01(\tR\x14issuerVerificationId\x12\x18\n\
    \x07version\x18\x08\x20\x01(\rR\x07version\"T\n\x20QueryGetVerificationD\
    ataResponse\x120\n\x04data\x18\x01\x20\x03(\x0b2\x1c.ffi.ffi.Verificatio\
    nDetailsR\x04data\"\x84\x08\n\rCosmosRequest\x12:\n\ngetAccount\x18\x01\
    \x20\x01(\x0b2\x18.ffi.ffi.QueryGetAccountH\0R\ngetAccount\x12C\n\rinser\
    tAccount\x18\x02\x20\x01(\x0b2\x1b.ffi.ffi.QueryInsertAccountH\0R\rinser\
    tAccount\x12=\n\x0bcontainsKey\x18\x03\x20\x01(\x0b2\x19.ffi.ffi.QueryCo\
    ntainsKeyH\0R\x0bcontainsKey\x12@\n\x0baccountCode\x18\x04\x20\x01(\x0b2\
    \x1c.ffi.ffi.QueryGetAccountCodeH\0R\x0baccountCode\x12G\n\x0bstorageCel\
    l\x18\x05\x20\x01(\x0b2#.ffi.ffi.QueryGetAccountStorageCellH\0R\x0bstora\
    geCell\x12O\n\x11insertAccountCode\x18\x06\x20\x01(\x0b2\x1f.ffi.ffi.Que\
    ryInsertAccountCodeH\0R\x11insertAccountCode\x12O\n\x11insertStorageCell\
    \x18\x07\x20\x01(\x0b2\x1f.ffi.ffi.QueryInsertStorageCellH\0R\x11insertS\
    torageCell\x12.\n\x06remove\x18\x08\x20\x01(\x0b2\x14.ffi.ffi.QueryRemov\
    eH\0R\x06remove\x12O\n\x11removeStorageCell\x18\t\x20\x01(\x0b2\x1f.ffi.\
    ...
    \tblockHash\x12^\n\x16addVerificationDetails\x18\x0c\x20\x01(\x0b2$.ffi.\
    ffi.QueryAddVerificationDetailsH\0R\x16addVerificationDetails\x12I\n\x0f\
    hasVerification\x18\r\x20\x01(\x0b2\x1d.ffi.ffi.QueryHasVerificationH\0R\
    \x0fhasVerification\x12U\n\x13getVerificationData\x18\x0e\x20\x01(\x0b2!\
    ...
    \x01(\x0b2\x1b.ffi.ffi.TransactionContextR\x07context\"\x16\n\x14NodePub\
    licKeyRequest\"5\n\x15NodePublicKeyResponse\x12\x1c\n\tpublicKey\x18\x01\
    \x20\x01(\x0cR\tpublicKey\"\xe4\x01\n\nFFIRequest\x12=\n\x0bcallRequest\
    \x18\x01\x20\x01(\x0b2\x19.ffi.ffi.SGXVMCallRequestH\0R\x0bcallRequest\
    \x12C\n\rcreateRequest\x18\x02\x20\x01(\x0b2\x1b.ffi.ffi.SGXVMCreateRequ\
    estH\0R\rcreateRequest\x12K\n\x10publicKeyRequest\x18\x03\x20\x01(\x0b2\
    \x1d.ffi.ffi.NodePublicKeyRequestH\0R\x10publicKeyRequestB\x05\n\x03reqB\
    &Z$github.com/SigmaGmbH/librustgo/typesJ\xc3I\n\x07\x12\x05\0\0\x81\x02\
    \x01\n\x08\n\x01\x0c\x12\x03\0\0\x12\n\x08\n\x01\x02\x12\x03\x02\0\x10\n\
    \x08\n\x01\x08\x12\x03\x04\0;\n\t\n\x02\x08\x0b\x12\x03\x04\0;\n\x1d\n\
    \x02\x04\0\x12\x04\x08\0\x0b\x012\x11\x20General\x20request\n\n\n\n\x03\
    \x04\0\x01\x12\x03\x08\x08\x16\n\x0b\n\x04\x04\0\x02\0\x12\x03\t\x02!\n\
    ...
    \x01\x01\x12\x03\"\x15\x1f\n\x0c\n\x05\x04\x03\x02\x01\x03\x12\x03\"\"#\
    \n\n\n\x02\x04\x04\x12\x04%\00\x01\n\n\n\x03\x04\x04\x01\x12\x03%\x08!\n\
    Z\n\x04\x04\x04\x02\0\x12\x03(\x02\x18\x1aM\x20logs\x20contains\x20the\
    \x20transaction\x20hash\x20and\x20the\x20proto-compatible\x20ethereum\n\
    \x20logs.\n\n\x0c\n\x05\x04\x04\x02\0\x04\x12\x03(\x02\n\n\x0c\n\x05\x04\
    \x04\x02\0\x06\x12\x03(\x0b\x0e\n\x0c\n\x05\x04\x04\x02\0\x01\x12\x03(\
    \x0f\x13\n\x0c\n\x05\x04\x04\x02\0\x03\x12\x03(\x16\x17\n\\\n\x04\x04\
    \x04\x02\x01\x12\x03+\x02\x10\x1aO\x20returned\x20data\x20from\x20evm\
    \x20function\x20(result\x20or\x20data\x20supplied\x20with\x20revert\n\
    ...
    \"\x02\x01\x12\x04\xad\x01\x02\x19\x1a(\x20From\x20which\x20chain\x20pro\
    of\x20was\x20transferred\n\n\r\n\x05\x04\"\x02\x01\x05\x12\x04\xad\x01\
    \x02\x08\n\r\n\x05\x04\"\x02\x01\x01\x12\x04\xad\x01\t\x14\n\r\n\x05\x04\
    \"\x02\x01\x03\x12\x04\xad\x01\x17\x18\n+\n\x04\x04\"\x02\x02\x12\x04\
    \xaf\x01\x02\x1f\x1a\x1d\x20Original\x20issuance\x20timestamp\n\n\r\n\
    ...
    \xb3\x01\x17\x18\n(\n\x04\x04\"\x02\x05\x12\x04\xb5\x01\x02\x14\x1a\x1a\
    \x20ZK-proof\x20original\x20schema\n\n\r\n\x05\x04\"\x02\x05\x05\x12\x04\
    \xb5\x01\x02\x08\n\r\n\x05\x04\"\x02\x05\x01\x12\x04\xb5\x01\t\x0f\n\r\n\
    \x05\x04\"\x02\x05\x03\x12\x04\xb5\x01\x12\x13\nN\n\x04\x04\"\x02\x06\
    \x12\x04\xb7\x01\x02\"\x1a@\x20Verification\x20id\x20for\x20checking(KYC\
    /KYB/AML\x20etc)\x20from\x20issuer\x20side\n\n\r\n\x05\x04\"\x02\x06\x05\
    \x12\x04\xb7\x01\x02\x08\n\r\n\x05\x04\"\x02\x06\x01\x12\x04\xb7\x01\t\
    \x1d\n\r\n\x05\x04\"\x02\x06\x03\x12\x04\xb7\x01\x20!\n\x17\n\x04\x04\"\
    \x02\x07\x12\x04\xb9\x01\x02\x15\x1a\t\x20Version\n\n\r\n\x05\x04\"\x02\
    \x07\x05\x12\x04\xb9\x01\x02\x08\n\r\n\x05\x04\"\x02\x07\x01\x12\x04\xb9\
    ...
    \0\x04\x12\x04\xbc\x01\x02\n\n\r\n\x05\x04#\x02\0\x06\x12\x04\xbc\x01\
