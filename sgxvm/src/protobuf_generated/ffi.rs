...
impl ::protobuf::Message for SGXVMCallParams {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.encrypted != false {
            os.write_bool(9, self.encrypted)?;
        }
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBool>(
                    "encrypted",
                    |m: &SGXVMCallParams| { &m.encrypted },
                    |m: &mut SGXVMCallParams| { &mut m.encrypted },
                ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x08\x20\x01(\x04R\x05nonce\x12\x1c\n\tencrypted\x18\t\x20\x01(\x08R\ten\
    ...
    \x18\x04\x20\x01(\x0cR\x05value\x127\n\naccessList\x18\x05\x20\x03(\x0b2\
    \x17.ffi.ffi.AccessListItemR\naccessList\x12\x16\n\x06commit\x18\x06\x20\
    \x01(\x08R\x06commit\x12\x14\n\x05nonce\x18\x07\x20\x01(\x04R\x05nonce\"\
    {\n\x10SGXVMCallRequest\x120\n\x06params\x18\x01\x20\x01(\x0b2\x18.ffi.f\
    fi.SGXVMCallParamsR\x06params\x125\n\x07context\x18\x02\x20\x01(\x0b2\
    \x1b.ffi.ffi.TransactionContextR\x07context\"\x7f\n\x12SGXVMCreateReques\
    t\x122\n\x06params\x18\x01\x20\x01(\x0b2\x1a.ffi.ffi.SGXVMCreateParamsR\
    \x06params\x125\n\x07context\x18\x02\x20\x01(\x0b2\x1b.ffi.ffi.Transacti\
    onContextR\x07context\"8\n\x14NodePublicKeyRequest\x12\x20\n\x0bblockNum\
    ber\x18\x01\x20\x01(\x04R\x0bblockNumber\"5\n\x15NodePublicKeyResponse\
    \x12\x1c\n\tpublicKey\x18\x01\x20\x01(\x0cR\tpublicKey\"y\n\tEpochData\
    \x12\x20\n\x0bepochNumber\x18\x01\x20\x01(\rR\x0bepochNumber\x12$\n\rsta\
    rtingBlock\x18\x02\x20\x01(\x04R\rstartingBlock\x12$\n\rnodePublicKey\
    \x18\x03\x20\x01(\x0cR\rnodePublicKey\"@\n\x12ListEpochsResponse\x12*\n\
    \x06epochs\x18\x01\x20\x03(\x0b2\x12.ffi.ffi.EpochDataR\x06epochs\"\xe4\
