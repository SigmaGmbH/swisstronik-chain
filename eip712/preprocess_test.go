...
var feePayerAddress = "swtr15srdmqa9934z6utqywsagt456va5xwjpwvmpth"
...
func createPopulatedTestCase(t *testing.T) TestCaseStruct {
	...
	msgSend := banktypes.MsgSend{
		...
		ToAddress:   "swtr15srdmqa9934z6utqywsagt456va5xwjpwvmpth",
		Amount: sdk.NewCoins(
			sdk.NewCoin(
				utils.BaseDenom,
