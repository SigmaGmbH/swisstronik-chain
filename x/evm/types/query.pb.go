...
func (m *EthCallRequest) GetEncrypted() bool {
	if m != nil {
		return m.Encrypted
	}
	return false
...
func (m *QueryTraceTxRequest) GetEncrypted() bool {
	if m != nil {
		return m.Encrypted
	}
	return false
...
var fileDescriptor_e15a877459347994 = []byte{
	...
	,
}
