...
static ENCLAVE_FILE: &'static str = "v1.0.1_checker_enclave.signed.so";

#[cfg(all(not(feature = "attestation_server"), not(feature = "checker_mode")))]
static ENCLAVE_FILE: &'static str = "v1.0.1_enclave.signed.so";

#[cfg(feature = "attestation_server")]
static ENCLAVE_FILE: &'static str = "v1.0.1_attestation_enclave.signed.so";
