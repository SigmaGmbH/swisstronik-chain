...
//! Generated file from `sgx-evm/protobuf_contracts/ffi.proto`
...
#[derive(PartialEq,Clone,Default)]
pub struct QueryVerifyCredential {
    // message fields
    pub issuer: ::std::vec::Vec<u8>,
    pub credentialId: ::std::vec::Vec<u8>,
    pub credentialAddress: ::std::vec::Vec<u8>,
...
impl<'a> ::std::default::Default for &'a QueryVerifyCredential {
    fn default() -> &'a QueryVerifyCredential {
        <QueryVerifyCredential as ::protobuf::Message>::default_instance()
    }
}

impl QueryVerifyCredential {
    pub fn new() -> QueryVerifyCredential {
        ::std::default::Default::default()
    }
    ...
    pub fn get_credentialId(&self) -> &[u8] {
        &self.credentialId
    }
    pub fn clear_credentialId(&mut self) {
        self.credentialId.clear();
    }

    // Param is passed by value, moved
    pub fn set_credentialId(&mut self, v: ::std::vec::Vec<u8>) {
        self.credentialId = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_credentialId(&mut self) -> &mut ::std::vec::Vec<u8> {
        &mut self.credentialId
    }

    // Take field
    pub fn take_credentialId(&mut self) -> ::std::vec::Vec<u8> {
        ::std::mem::replace(&mut self.credentialId, ::std::vec::Vec::new())
    }

    // bytes credentialAddress = 2;


    pub fn get_credentialAddress(&self) -> &[u8] {
        &self.credentialAddress
    }
    pub fn clear_credentialAddress(&mut self) {
        self.credentialAddress.clear();
    }

    // Param is passed by value, moved
    pub fn set_credentialAddress(&mut self, v: ::std::vec::Vec<u8>) {
        self.credentialAddress = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_credentialAddress(&mut self) -> &mut ::std::vec::Vec<u8> {
        &mut self.credentialAddress
    }

    // Take field
    pub fn take_credentialAddress(&mut self) -> ::std::vec::Vec<u8> {
        ::std::mem::replace(&mut self.credentialAddress, ::std::vec::Vec::new())
    }
...
impl ::protobuf::Message for QueryVerifyCredential {
    fn is_initialized(&self) -> bool {
        true
    }
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                3 => {
                    ::protobuf::rt::read_singular_proto3_bytes_into(wire_type, is, &mut self.credentialId)?;
                },
                2 => {
                    ::protobuf::rt::read_singular_proto3_bytes_into(wire_type, is, &mut self.credentialAddress)?;
                },
                4 => {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.issuer.is_empty() {
            my_size += ::protobuf::rt::bytes_size(1, &self.issuer);
        }
        if !self.credentialId.is_empty() {
            my_size += ::protobuf::rt::bytes_size(3, &self.credentialId);
        }
        if !self.credentialAddress.is_empty() {
            my_size += ::protobuf::rt::bytes_size(2, &self.credentialAddress);
        }
        if !self.proof.is_empty() {
            my_size += ::protobuf::rt::bytes_size(4, &self.proof);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        if !self.issuer.is_empty() {
            os.write_bytes(1, &self.issuer)?;
        }
        if !self.credentialId.is_empty() {
            os.write_bytes(3, &self.credentialId)?;
        }
        if !self.credentialAddress.is_empty() {
            os.write_bytes(2, &self.credentialAddress)?;
        }
        if !self.proof.is_empty() {
            os.write_bytes(4, &self.proof)?;
        }
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
    ...
    fn new() -> QueryVerifyCredential {
        QueryVerifyCredential::new()
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBytes>(
                    "issuer",
                    |m: &QueryVerifyCredential| { &m.issuer },
                    |m: &mut QueryVerifyCredential| { &mut m.issuer },
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBytes>(
                    "credentialId",
                    |m: &QueryVerifyCredential| { &m.credentialId },
                    |m: &mut QueryVerifyCredential| { &mut m.credentialId },
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBytes>(
                    "credentialAddress",
                    |m: &QueryVerifyCredential| { &m.credentialAddress },
                    |m: &mut QueryVerifyCredential| { &mut m.credentialAddress },
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBytes>(
                    "proof",
                    |m: &QueryVerifyCredential| { &m.proof },
                    |m: &mut QueryVerifyCredential| { &mut m.proof },
                ));
                ::protobuf::reflect::MessageDescriptor::new::<QueryVerifyCredential>(
                    "QueryVerifyCredential",
                    fields,
                    file_descriptor_proto()
                )
            })
    ...
    fn default_instance() -> &'static QueryVerifyCredential {
        static mut instance: ::protobuf::lazy::Lazy<QueryVerifyCredential> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const QueryVerifyCredential,
        };
        unsafe {
            instance.get(QueryVerifyCredential::new)
        }
    }
}

impl ::protobuf::Clear for QueryVerifyCredential {
    fn clear(&mut self) {
        self.issuer.clear();
        self.credentialId.clear();
        self.credentialAddress.clear();
...
impl ::std::fmt::Debug for QueryVerifyCredential {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for QueryVerifyCredential {
    fn as_ref(&self) -> ::protobuf::reflect::ProtobufValueRef {
        ::protobuf::reflect::ProtobufValueRef::Message(self)
    }
}
...
#[derive(PartialEq,Clone,Default)]
pub struct QueryVerifyCredentialResponse {
    // message fields
    pub credentialAddress: ::std::vec::Vec<u8>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
...
impl<'a> ::std::default::Default for &'a QueryVerifyCredentialResponse {
    fn default() -> &'a QueryVerifyCredentialResponse {
        <QueryVerifyCredentialResponse as ::protobuf::Message>::default_instance()
    }
}

impl QueryVerifyCredentialResponse {
    pub fn new() -> QueryVerifyCredentialResponse {
        ::std::default::Default::default()
    }

    // bytes credentialAddress = 1;
...
impl ::protobuf::Message for QueryVerifyCredentialResponse {
    fn is_initialized(&self) -> bool {
        true
    }
    ...
    fn compute_size(&self) -> u32 {
        let mut my_size = 0;
        if !self.credentialAddress.is_empty() {
            my_size += ::protobuf::rt::bytes_size(1, &self.credentialAddress);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        if !self.credentialAddress.is_empty() {
            os.write_bytes(1, &self.credentialAddress)?;
        }
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
    ...
    fn new() -> QueryVerifyCredentialResponse {
        QueryVerifyCredentialResponse::new()
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBytes>(
                    "credentialAddress",
                    |m: &QueryVerifyCredentialResponse| { &m.credentialAddress },
                    |m: &mut QueryVerifyCredentialResponse| { &mut m.credentialAddress },
                ));
                ::protobuf::reflect::MessageDescriptor::new::<QueryVerifyCredentialResponse>(
                    "QueryVerifyCredentialResponse",
                    fields,
                    file_descriptor_proto()
                )
            })
    ...
    fn default_instance() -> &'static QueryVerifyCredentialResponse {
        static mut instance: ::protobuf::lazy::Lazy<QueryVerifyCredentialResponse> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const QueryVerifyCredentialResponse,
        };
        unsafe {
            instance.get(QueryVerifyCredentialResponse::new)
        }
    }
}

impl ::protobuf::Clear for QueryVerifyCredentialResponse {
    fn clear(&mut self) {
        self.credentialAddress.clear();
        self.unknown_fields.clear();
    }
...
impl ::std::fmt::Debug for QueryVerifyCredentialResponse {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for QueryVerifyCredentialResponse {
    fn as_ref(&self) -> ::protobuf::reflect::ProtobufValueRef {
        ::protobuf::reflect::ProtobufValueRef::Message(self)
    }
}
...
pub enum CosmosRequest_oneof_req {
    ...
    verifyCredential(QueryVerifyCredential),
}
...
impl CosmosRequest {
    ...
    // .ffi.ffi.QueryVerifyCredential verifyCredential = 12;


    pub fn get_verifyCredential(&self) -> &QueryVerifyCredential {
        match self.req {
            ::std::option::Option::Some(CosmosRequest_oneof_req::verifyCredential(ref v)) => v,
            _ => QueryVerifyCredential::default_instance(),
        }
    }
    pub fn clear_verifyCredential(&mut self) {
        self.req = ::std::option::Option::None;
    }

    pub fn has_verifyCredential(&self) -> bool {
        match self.req {
            ::std::option::Option::Some(CosmosRequest_oneof_req::verifyCredential(..)) => true,
            _ => false,
        }
    }

    // Param is passed by value, moved
    pub fn set_verifyCredential(&mut self, v: QueryVerifyCredential) {
        self.req = ::std::option::Option::Some(CosmosRequest_oneof_req::verifyCredential(v))
    }

    // Mutable pointer to the field.
    pub fn mut_verifyCredential(&mut self) -> &mut QueryVerifyCredential {
        if let ::std::option::Option::Some(CosmosRequest_oneof_req::verifyCredential(_)) = self.req {
        } else {
            self.req = ::std::option::Option::Some(CosmosRequest_oneof_req::verifyCredential(QueryVerifyCredential::new()));
        }
        match self.req {
            ::std::option::Option::Some(CosmosRequest_oneof_req::verifyCredential(ref mut v)) => v,
            _ => panic!(),
        }
    }

    // Take field
    pub fn take_verifyCredential(&mut self) -> QueryVerifyCredential {
        if self.has_verifyCredential() {
            match self.req.take() {
                ::std::option::Option::Some(CosmosRequest_oneof_req::verifyCredential(v)) => v,
                _ => panic!(),
            }
        } else {
            QueryVerifyCredential::new()
...
impl ::protobuf::Message for CosmosRequest {
    fn is_initialized(&self) -> bool {
        ...
        if let Some(CosmosRequest_oneof_req::verifyCredential(ref v)) = self.req {
            if !v.is_initialized() {
                return false;
            }
        }
        ...
        while !is.eof()? {
            ...
            match field_number {
                ...
                12 => {
                    ...
                    self.req = ::std::option::Option::Some(CosmosRequest_oneof_req::verifyCredential(is.read_message()?));
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let ::std::option::Option::Some(ref v) = self.req {
            match v {
                ...
                &CosmosRequest_oneof_req::verifyCredential(ref v) => {
                    let len = v.compute_size();
                    my_size += 1 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
                },
            };
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_singular_message_accessor::<_, QueryVerifyCredential>(
                    "verifyCredential",
                    CosmosRequest::has_verifyCredential,
                    CosmosRequest::get_verifyCredential,
                ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n$sgx-evm/protobuf_contracts/ffi.proto\x12\x07ffi.ffi\"L\n\x0eAccessLis\
    tItem\x12\x20\n\x0bstorageSlot\x18\x01\x20\x03(\x0cR\x0bstorageSlot\x12\
    \x18\n\x07address\x18\x02\x20\x01(\x0cR\x07address\"\xb4\x01\n\x0fTransa\
    ctionData\x12\x12\n\x04from\x18\x01\x20\x01(\x0cR\x04from\x12\x0e\n\x02t\
    o\x18\x02\x20\x01(\x0cR\x02to\x12\x12\n\x04data\x18\x03\x20\x01(\x0cR\
    \x04data\x12\x1a\n\x08gasLimit\x18\x04\x20\x01(\x04R\x08gasLimit\x12\x14\
    \n\x05value\x18\x05\x20\x01(\x0cR\x05value\x127\n\naccessList\x18\x06\
    \x20\x03(\x0b2\x17.ffi.ffi.AccessListItemR\naccessList\"\x90\x02\n\x12Tr\
    ansactionContext\x12\x19\n\x08chain_id\x18\x01\x20\x01(\x04R\x07chainId\
    \x12\x1b\n\tgas_price\x18\x02\x20\x01(\x0cR\x08gasPrice\x12\x1c\n\ttimes\
    tamp\x18\x03\x20\x01(\x04R\ttimestamp\x12&\n\x0fblock_gas_limit\x18\x04\
    \x20\x01(\x04R\rblockGasLimit\x122\n\x16block_base_fee_per_gas\x18\x05\
    \x20\x01(\x0cR\x12blockBaseFeePerGas\x12%\n\x0eblock_coinbase\x18\x06\
    \x20\x01(\x0cR\rblockCoinbase\x12!\n\x0cblock_number\x18\x07\x20\x01(\
    \x04R\x0bblockNumber\"\x89\x01\n\x18HandleTransactionRequest\x121\n\x07t\
    x_data\x18\x01\x20\x01(\x0b2\x18.ffi.ffi.TransactionDataR\x06txData\x12:\
    \n\ntx_context\x18\x02\x20\x01(\x0b2\x1b.ffi.ffi.TransactionContextR\ttx\
    Context\"\x85\x01\n\x19HandleTransactionResponse\x12\x20\n\x04logs\x18\
    \x02\x20\x03(\x0b2\x0c.ffi.ffi.LogR\x04logs\x12\x10\n\x03ret\x18\x03\x20\
    \x01(\x0cR\x03ret\x12\x19\n\x08vm_error\x18\x04\x20\x01(\tR\x07vmError\
    \x12\x19\n\x08gas_used\x18\x05\x20\x01(\x04R\x07gasUsed\"\x1d\n\x05Topic\
    \x12\x14\n\x05inner\x18\x01\x20\x01(\x0cR\x05inner\"[\n\x03Log\x12\x18\n\
    \x07address\x18\x01\x20\x01(\x0cR\x07address\x12&\n\x06topics\x18\x02\
    \x20\x03(\x0b2\x0e.ffi.ffi.TopicR\x06topics\x12\x12\n\x04data\x18\x03\
    ...
    \x0cR\x07balance\x12\x14\n\x05nonce\x18\x03\x20\x01(\x04R\x05nonce\"\x1c\
    ...
    esponse\x12\x12\n\x04hash\x18\x01\x20\x01(\x0cR\x04hash\"\x97\x01\n\x15Q\
    ueryVerifyCredential\x12\x16\n\x06issuer\x18\x01\x20\x01(\x0cR\x06issuer\
    \x12\"\n\x0ccredentialId\x18\x03\x20\x01(\x0cR\x0ccredentialId\x12,\n\
    \x11credentialAddress\x18\x02\x20\x01(\x0cR\x11credentialAddress\x12\x14\
    \n\x05proof\x18\x04\x20\x01(\x0cR\x05proof\"M\n\x1dQueryVerifyCredential\
    Response\x12,\n\x11credentialAddress\x18\x01\x20\x01(\x0cR\x11credential\
    ...
    \tblockHash\x12L\n\x10verifyCredential\x18\x0c\x20\x01(\x0b2\x1e.ffi.ffi\
    .QueryVerifyCredentialH\0R\x10verifyCredentialB\x05\n\x03req\"\xe2\x01\n\
    \x0fSGXVMCallParams\x12\x12\n\x04from\x18\x01\x20\x01(\x0cR\x04from\x12\
    \x0e\n\x02to\x18\x02\x20\x01(\x0cR\x02to\x12\x12\n\x04data\x18\x03\x20\
    \x01(\x0cR\x04data\x12\x1a\n\x08gasLimit\x18\x04\x20\x01(\x04R\x08gasLim\
    it\x12\x14\n\x05value\x18\x05\x20\x01(\x0cR\x05value\x127\n\naccessList\
    \x18\x06\x20\x03(\x0b2\x17.ffi.ffi.AccessListItemR\naccessList\x12\x16\n\
    \x06commit\x18\x07\x20\x01(\x08R\x06commit\x12\x14\n\x05nonce\x18\x08\
    \x20\x01(\x04R\x05nonce\"\xd4\x01\n\x11SGXVMCreateParams\x12\x12\n\x04fr\
    om\x18\x01\x20\x01(\x0cR\x04from\x12\x12\n\x04data\x18\x02\x20\x01(\x0cR\
    \x04data\x12\x1a\n\x08gasLimit\x18\x03\x20\x01(\x04R\x08gasLimit\x12\x14\
    \n\x05value\x18\x04\x20\x01(\x0cR\x05value\x127\n\naccessList\x18\x05\
    \x20\x03(\x0b2\x17.ffi.ffi.AccessListItemR\naccessList\x12\x16\n\x06comm\
    it\x18\x06\x20\x01(\x08R\x06commit\x12\x14\n\x05nonce\x18\x07\x20\x01(\
    \x04R\x05nonce\"{\n\x10SGXVMCallRequest\x120\n\x06params\x18\x01\x20\x01\
    (\x0b2\x18.ffi.ffi.SGXVMCallParamsR\x06params\x125\n\x07context\x18\x02\
    ...
    \x88\x01./\n\x0c\n\x02\x04\x1d\x12\x06\x8a\x01\0\x8f\x01\x01\n\x0b\n\x03\
    \x04\x1d\x01\x12\x04\x8a\x01\x08\x1d\n\x0c\n\x04\x04\x1d\x02\0\x12\x04\
    \x8b\x01\x02\x13\n\r\n\x05\x04\x1d\x02\0\x05\x12\x04\x8b\x01\x02\x07\n\r\
    \n\x05\x04\x1d\x02\0\x01\x12\x04\x8b\x01\x08\x0e\n\r\n\x05\x04\x1d\x02\0\
    \x03\x12\x04\x8b\x01\x11\x12\n\x0c\n\x04\x04\x1d\x02\x01\x12\x04\x8c\x01\
    \x02\x19\n\r\n\x05\x04\x1d\x02\x01\x05\x12\x04\x8c\x01\x02\x07\n\r\n\x05\
    \x04\x1d\x02\x01\x01\x12\x04\x8c\x01\x08\x14\n\r\n\x05\x04\x1d\x02\x01\
    \x03\x12\x04\x8c\x01\x17\x18\n\x0c\n\x04\x04\x1d\x02\x02\x12\x04\x8d\x01\
    \x02\x1e\n\r\n\x05\x04\x1d\x02\x02\x05\x12\x04\x8d\x01\x02\x07\n\r\n\x05\
    \x04\x1d\x02\x02\x01\x12\x04\x8d\x01\x08\x19\n\r\n\x05\x04\x1d\x02\x02\
    \x03\x12\x04\x8d\x01\x1c\x1d\n\x0c\n\x04\x04\x1d\x02\x03\x12\x04\x8e\x01\
