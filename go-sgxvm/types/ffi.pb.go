...
var file_ffi_proto_rawDesc = []byte{
	...
	0x74, 0x52, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x22, 0x39, 0x0a, 0x14, 0x4e, 0x6f,
	...
	0x0c, 0x52, 0x09, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b, 0x65, 0x79, 0x22, 0xe4, 0x01, 0x0a,
...
var file_ffi_proto_msgTypes = make([]protoimpl.MessageInfo, 41)
var file_ffi_proto_goTypes = []interface{}{
	...
	(*FFIRequest)(nil),                          // 40: ffi.ffi.FFIRequest
}
var file_ffi_proto_depIdxs = []int32{
	...
	36, // 24: ffi.ffi.FFIRequest.callRequest:type_name -> ffi.ffi.SGXVMCallRequest
	37, // 25: ffi.ffi.FFIRequest.createRequest:type_name -> ffi.ffi.SGXVMCreateRequest
	38, // 26: ffi.ffi.FFIRequest.publicKeyRequest:type_name -> ffi.ffi.NodePublicKeyRequest
...
func file_ffi_proto_init() {
	...
	file_ffi_proto_msgTypes[40].OneofWrappers = []interface{}{
