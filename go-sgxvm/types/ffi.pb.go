...
func file_ffi_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_ffi_proto_msgTypes[60].Exporter = func(v any, i int) any {
		...
		file_ffi_proto_msgTypes[61].Exporter = func(v any, i int) any {
		...
		file_ffi_proto_msgTypes[62].Exporter = func(v any, i int) any {
		...
		file_ffi_proto_msgTypes[63].Exporter = func(v any, i int) any {
		...
		file_ffi_proto_msgTypes[64].Exporter = func(v any, i int) any {
		...
		file_ffi_proto_msgTypes[65].Exporter = func(v any, i int) any {
