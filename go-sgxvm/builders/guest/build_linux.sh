...
cp target/x86_64-unknown-linux-gnu/release/libsgx_wrapper.so artifacts/libsgx_wrapper.x86_64.so
...
cp target/aarch64-unknown-linux-gnu/release/libsgx_wrapper.so artifacts/libsgx_wrapper.aarch64.so
