...
func New(
	...
	*/
	...
	app.SwisstronikKeeper = *swisstronikmodulekeeper.NewKeeper(
		appCodec,
		keys[swisstronikmoduletypes.StoreKey],
		keys[swisstronikmoduletypes.MemStoreKey],
		app.GetSubspace(swisstronikmoduletypes.ModuleName),
	)
