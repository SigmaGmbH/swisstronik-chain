...
func NewSimappWithCustomOptions(t *testing.T, isCheckTx bool, options SetupOptions) *SimApp {
	...
	balance := banktypes.Balance{
		...
		Coins:   sdk.NewCoins(sdk.NewCoin(sapp.AccountAddressPrefix, sdk.NewInt(100000000000000))),
	}
...
func Setup(t *testing.T, isCheckTx bool) (*SimApp, *authtypes.BaseAccount) {
	t.Helper()
