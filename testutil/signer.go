...
func (ts TestSigner) Sign(uid string, msg []byte, signMode txsigning.SignMode) ([]byte, cryptotypes.PubKey, error) {
...
func (ts TestSigner) SignByAddress(address sdk.Address, msg []byte, signMode txsigning.SignMode) ([]byte, cryptotypes.PubKey, error) {
